...
class AIVoiceAssistant:
    ...
    def _create_kb(self):
        try:
            reader = SimpleDirectoryReader(
                input_files=[r"D:\Projects\Voice_Assistant LLM\RAG\Motors Data.txt"]
            )
    ...
    def _prompt(self):
        return """
            You are a professional AI Assistant working for LizMotors Pvt Ltd, a leading company in electric mobility solutions.
            Ask questions mentioned inside square brackets which you have to ask from the customer, DON'T ASK THESE QUESTIONS 
            IN ONE go and keep the conversation engaging! Always ask questions one by one only!
        
            [Ask for the customer's name and vehicle model, inquire about the issue or request they have, and end the conversation with a friendly and professional greeting.]
